...
export default function KeypadPage() {
    ...
    const loadPhones = () => {
        ...
        const keypadPhones = allPhones.filter((p) => p.type === 'Keypad');
        setPhones(keypadPhones);
    };
    ...
    return (
        <div className="py-6">
            <div className="flex justify-between items-center mb-8 gap-4 flex-wrap">
                <h1 className="text-4xl font-bold text-gray-800">Keypad Phones</h1>
                <button
                    onClick={() => {
                        setEditingPhone(undefined);
                        setShowModal(true);
            ...
            <div className="mb-4 text-sm text-gray-600">
                Showing {filteredPhones.length} of {phones.length} Keypad phones
            </div>
